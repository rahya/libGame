...
TEST_CREATE(endianess_clientServer) {
  ...
  auto test = [](test::Campaign& iCampaign, network::buffer::Output& ioBufferOutput, network::buffer::Input& ioBufferInput, network::tcp::Socket& aSocketClientOnServerSide, network::tcp::Client& aClient, int32_t iInt) {
    ...
    int aValue;
    bool aSuccess = network::message::Endianess::getQuery(ioBufferInput, aValue);
...
TEST_CREATE(renameUser_clientServer) {
  ...
  auto test = [](test::Campaign& iCampaign, network::buffer::Output& ioBufferOutput, network::buffer::Input& ioBufferInput, 
    network::tcp::Socket& aSocketClientOnServerSide, network::tcp::Client& aClient, const char* iName, const char* iExpectedResult) {
...
TEST_CREATE(textChat_clientServer) {
  ...
  auto test = [](test::Campaign& iCampaign, network::buffer::Output& ioBufferOutput, network::buffer::Input& ioBufferInput, 
    network::tcp::Socket& aSocketClientOnServerSide, network::tcp::Client& aClient, const char* iText, const char* iExpectedResult) {
...
namespace test::network::tcpMessage {

  void all(TEST_CAMPAIGN_PARAMETER) {
    TEST_CAMPAIGN_SUB("network::tcpMessage");
