...
#define TEST_CREATE(NAME) \
  struct C_ ## NAME{\
    ::test::Campaign& iCampaign;\
    C_ ## NAME(::test::Campaign& ioCampaign) : iCampaign(ioCampaign) { iCampaign.beginTest(#NAME); }\
...
#define TEST_CAMPAIGN ::test::Campaign aCampaign;
#define TEST_CAMPAIGN_ARGUMENT iCampaign
#define TEST_CAMPAIGN_PARAMETER ::test::Campaign& iCampaign
