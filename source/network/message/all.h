...
namespace network::message {
  ...
  struct Description {
    ...
    static network::buffer::Output& setQuery(network::buffer::Output& ioBuffer) {
        ioBuffer.reset(network::message::Header::id::description);
        return ioBuffer;
    }

    static network::buffer::Output& setResponse(network::buffer::Output& ioBuffer, const char* iDescription) {
        ioBuffer.reset(network::message::Header::id::description);
        ioBuffer.write(iDescription);
        return ioBuffer;
    }

    static std::tuple<bool, const char*> getResponse(network::buffer::Input& ioBufferInput) {
    ...
    static void handle(::network::tcp::Socket& ioSocket, const char* iDescription, const size_t iSize, network::buffer::Output& ioBuffer) {
      size_t aTotalSize = sizeof(network::message::Header) + iSize;
      ioBuffer.reset(network::message::Header::id::description);
  ...
  struct Error {
      ...
      static network::buffer::Output& setResponse(network::buffer::Output& ioBuffer, network::message::Header::id iErrorId, const char* iErrorString) {
  ...
  struct Rename {
    ...
    static network::buffer::Output& setQuery(network::buffer::Output& ioBuffer, const char* iName) {
      ioBuffer.reset(network::message::Header::id::rename);
      ioBuffer.write(iName);
      return ioBuffer;
    }

    static std::tuple<bool, const char*> getQuery(network::buffer::Input& ioBufferInput) {
      const char* aName;
    ...
    /*
    static network::buffer::Output& setResponse(network::buffer::Output& ioBuffer, int32_t iNum) {
      ioBuffer.reset(network::message::Header::id::endianess);
      char buffer[20];
    ...
    static bool getResponse(network::buffer::Input& ioBufferInput, const char*& ioIntCharPtr) {
  ...
  struct Endianess {
    ...
    static network::buffer::Output& setQuery(network::buffer::Output& ioBuffer, int32_t iNum) {
      ioBuffer.reset(network::message::Header::id::endianess);
      ioBuffer.write(iNum);
      return ioBuffer;
    }

    static bool getQuery(network::buffer::Input& ioBufferInput, int32_t& ioInt) {
  ...
  namespace chat {
    ...
    struct Text {
      ...
      static network::buffer::Output& setQuery(network::buffer::Output& ioBuffer, const char* aMessage) {
        ioBuffer.reset(network::message::Header::id::chat);
        ioBuffer.write(aMessage, std::min(strlen(aMessage), _kLength));
        return ioBuffer;
      }

      static std::tuple<bool, const char*> getQuery(network::buffer::Input& ioBuffer) {
        const char* aResult;
      ...
      static network::buffer::Output& setResponse(network::buffer::Output& ioBuffer, ::game::player::Name aName, const char* aMessage) {
        ioBuffer.reset(network::message::Header::id::chat);
      ...
      static std::tuple<bool, const char*, const char*> getResponse(network::buffer::Input& ioBuffer) {
        const char* aName;
        const char* aText;
...
#pragma pack(pop)
  ...
  namespace lobby {
    ...
    struct Change {
      ...
      static network::buffer::Output& setResponse(network::buffer::Output& ioBuffer, uint8_t phaseId) {
          ioBuffer.reset(network::message::Header::id::phaseChange);
          ioBuffer.write(phaseId);
          return ioBuffer;
      }

      static std::tuple<bool, uint8_t> getResponse(network::buffer::Input& ioBuffer) {
          uint8_t aPhaseId; 
    ...
    struct Join {
      using query = ::lobby::Key;


      static network::buffer::Output& setQuery(network::buffer::Output& ioBuffer, ::lobby::Key iKey) {
          ioBuffer.reset(network::message::Header::id::lobbyJoin);
          iKey.serialize(ioBuffer);
          return ioBuffer;
      }

      static std::tuple<bool, ::lobby::Key> getQuery(network::buffer::Input& ioBuffer) {
          ::lobby::Key aKey;
          bool aSuccess = aKey.deserialize(ioBuffer);
          return std::tuple<bool, ::lobby::Key>{ aSuccess, aKey };
      }

      static network::buffer::Output& setResponse(network::buffer::Output& ioBuffer, uint8_t iPhaseId) {
    ...
    struct Create {
      using response = ::lobby::Key;

      static network::buffer::Output& setQuery(network::buffer::Output& ioBuffer) {
          ioBuffer.reset(network::message::Header::id::lobbyCreate);
          return ioBuffer;
      }
      ...
      */
      ...
      static network::buffer::Output& setResponse(network::buffer::Output& ioBuffer, ::lobby::Key iKey) {
          ioBuffer.reset(network::message::Header::id::lobbyCreate);
          iKey.serialize(ioBuffer);
          return ioBuffer;
      }

      static std::tuple<bool, ::lobby::Key> getResponse(network::buffer::Input& ioBuffer) {
          ::lobby::Key aKey;
          bool aSuccess = aKey.deserialize(ioBuffer);
    ...
    struct List {
      ...
      static network::buffer::Output& initResponse(network::buffer::Output& ioBuffer) {
        ioBuffer.reset(network::message::Header::id::lobbyList);
        return ioBuffer;
      }

      static network::buffer::Output& addUserName(network::buffer::Output& ioBuffer, const char* iUserName) {
        ioBuffer.write(iUserName);
        return ioBuffer;
      }

      static bool getResponse(network::buffer::Input& ioBufferInput, std::vector<const char*>& oNameList) {
      ...
      static std::tuple<bool, std::vector<const char*>>  getResponse(network::buffer::Input& ioBufferInput) {
    ...
    struct Quit {
      ...
      static network::buffer::Output& setQuery(network::buffer::Output& ioBuffer) {
          ioBuffer.reset(network::message::Header::id::lobbyQuit);
          return ioBuffer;
      }
      ...
      /*
      static std::tuple<bool, const char*> getQuery(network::buffer::Input& ioBuffer, const char* iPrefix) {
          const char* aResult;
          bool aSuccess = ioBuffer.read(aResult);
          return std::tuple<bool, const char*>{ aSuccess, aResult };
      }
...
#pragma pack(push, 1)
      struct query {
        ::game::Configuration::adventureType adventureType;
      };
      struct response {
        uint32_t width;
        uint32_t height;
        ::game::map::Position PlayerPosition[8];
        uint16_t stepSpeed;
      };
#pragma pack(pop)


      static network::buffer::Output& setQuery(network::buffer::Output& ioBuffer, ::game::Configuration::adventureType iAdventureType) {
        ioBuffer.reset(network::message::Header::id::gameStart);
      ...
      template<typename T>
      static std::tuple<bool, ::game::Configuration::adventureType> getQuery(T& ioSocket, const char* iPrefix) {
      ...
      static network::buffer::Output& setResponse(network::buffer::Output& ioBuffer, const std::vector<::game::player::Info>& iAllPlayer, const ::game::Configuration& iConfig) {
        ioBuffer.reset(network::message::Header::id::gameStart);
      ...
      template<typename T>
      static std::tuple<bool, ::game::map::Size, std::vector<::game::player::Info>&, uint16_t> getResponse(network::buffer::Input& ioBuffer, ::network::message::Header aHeader, T& ioSocket, const char* iPrefix) {
        std::tuple<bool, ::game::map::Size, std::vector<::game::player::Info>&, uint16_t> aResult;
        ioBuffer.reset(network::message::Header::id::gameStart);
        std::get<bool>(aResult) = ioSocket.read(iPrefix, ioBuffer.getPayload(), aHeader.getPayloadSize()).first;
        ioBuffer.read(std::get<::game::map::Size   >(aResult).width, sizeof(::game::map::Size::value_type));
        ioBuffer.read(std::get<::game::map::Size   >(aResult).heigth, sizeof(::game::map::Size::value_type));
        /*
    ...
    struct playerMoveVector {
      ...
      static network::buffer::Output& setQuery(network::buffer::Output& ioBuffer, math::Vector iPlayerMoveVector) {
        ioBuffer.reset(network::message::Header::id::gamePlayerMoveVector);
      ...
      template<typename T>
      static std::tuple<bool, math::Vector> getQuery(T& ioSocket, const char* iPrefix) {
      ...
      static network::buffer::Output& setResponse(network::buffer::Output& ioBuffer, uint8_t iPlayerNum, ::game::map::Position iPlayerPosition, math::Vector iPlayerMoveVector) {
        ioBuffer.reset(network::message::Header::id::gamePlayerMoveVector);
      ...
      template<typename T>
      static std::tuple<bool, uint8_t, ::game::map::Position, math::Vector> getResponse(T& ioSocket, const char* iPrefix) {
        std::tuple<bool, uint8_t, ::game::map::Position, math::Vector> aResult;
        std::get<bool>(aResult) = ioSocket.read(iPrefix, reinterpret_cast<char*>(&std::get<uint8_t   >(aResult)), sizeof(uint8_t)).first;
        ::game::map::Position::type_t aSubTypePos;
        std::get<bool>(aResult) &= ioSocket.read(iPrefix, reinterpret_cast<char*>(&aSubTypePos), sizeof(::game::map::Position::type_t)).first;
        std::get<::game::map::Position>(aResult).x = aSubTypePos;
        std::get<bool>(aResult) &= ioSocket.read(iPrefix, reinterpret_cast<char*>(&aSubTypePos), sizeof(::game::map::Position::type_t)).first;
        std::get<::game::map::Position>(aResult).y = aSubTypePos;
...
#pragma pack(push, 1)
      ...
      struct response {
        uint8_t playerNum;
        ::game::map::Position PlayerPosition;
      };
#pragma pack(pop)
