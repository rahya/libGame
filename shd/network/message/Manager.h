...
namespace shd::network::message {
  ...
  struct Manager {
    ...
    std::function<void(::shd::game::player::Info*, shd::network::message::Header)> _functionDefault;

    Manager(std::function<void(::shd::game::player::Info*, shd::network::message::Header)> iFunctionDefault) {
    ...
    std::function<void(::shd::game::player::Info*, shd::network::message::Header)> operator[](const size_t iPos) {
      return std::get<1>(_descFun[iPos]);
    }

    using messageDescFun = std::tuple<
      std::pair<shd::network::message::Description, shd::network::message::Description>,
      std::function<void(::shd::game::player::Info*, shd::network::message::Header)>,
      const char*,
      shd::network::message::Header::id
    >;
    std::array<messageDescFun, 14> _descFun = {
#define NEW_MESSAGE(NAME,ID) messageDescFun{ shd::network::message::NAME         ::getDescriptions(), nullptr, #NAME, ID }
      NEW_MESSAGE(Endianess,                    shd::network::message::Header::id::endianess),
      NEW_MESSAGE(Description,                  shd::network::message::Header::id::description),
      NEW_MESSAGE(Rename,                       shd::network::message::Header::id::rename),
      NEW_MESSAGE(chat::Text,                   shd::network::message::Header::id::chat),
      NEW_MESSAGE(lobby::Create,                shd::network::message::Header::id::lobbyCreate),
      NEW_MESSAGE(lobby::Join,                  shd::network::message::Header::id::lobbyJoin),
      NEW_MESSAGE(lobby::List,                  shd::network::message::Header::id::lobbyList),
      NEW_MESSAGE(lobby::Quit,                  shd::network::message::Header::id::lobbyQuit),
      NEW_MESSAGE(lobby::Change,                shd::network::message::Header::id::phaseChange),
      NEW_MESSAGE(Acknowledge,                  shd::network::message::Header::id::acknowledege),
      NEW_MESSAGE(game::Start,                  shd::network::message::Header::id::gameStart),
      NEW_MESSAGE(game::Stop,                   shd::network::message::Header::id::gameStop),
      NEW_MESSAGE(game::playerMoveVector,       shd::network::message::Header::id::gamePlayerMoveVector),
      NEW_MESSAGE(game::playerMoveStop,         shd::network::message::Header::id::gamePlayerMoveStop),
...
#undef NEW_MESSAGE
    ...
    void update(Header::id iId, std::function<void(::shd::game::player::Info*, shd::network::message::Header)> iFunction) {
