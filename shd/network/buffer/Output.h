...
namespace shd::network::buffer {
  ...
  public:
    ...
    shd::network::message::Header* getHeader() {
      return reinterpret_cast<shd::network::message::Header*>(_buffer);
    }
    const shd::network::message::Header* getHeader() const {
      return reinterpret_cast<shd::network::message::Header*>(_buffer);
    }
    char* getPayload() {
      return &(_buffer[sizeof(shd::network::message::Header)]);
    }
    char* getPayload(size_t iPos) {
      return &(_buffer[sizeof(shd::network::message::Header) + iPos]);
    }
    char* getPayloadEnd() {
    ...
    void reset(const shd::network::message::Header::id iCode) {
